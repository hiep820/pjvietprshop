                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-control">
                                        {{ getCategory($categorys, 0, "", $product->category->id) }}
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select  name="state" class="form-control">
                                        <option @if($product->state == 1) selected @endif value="1">Đang bán</option>
                                        <option @if($product->state == 0) selected @endif value="0">Ngừng bán</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <img id="avatar" class="thumbnail" width="100%" height="350px" src="images/{{ $product->img }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
