									...
									<tbody>
										...
										<tr>
                                            ...
                                            <td>
                                            	...
                                            	@else
                                            		<span class="btn btn-warning">Member</span>
                                            	@endif
                                            </td>
											<td>
												<a href="/admin/user/edit/{{ $row->id }}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
												<a onClick="return del_user('{{ $row->email }}')" href="/admin/user/delete/{{ $row->id }}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
                                        </tr>
										@endforeach
									</tbody>
...
<script>
	function del_user(email){
		return confirm("Bạn có muốn xóa Thành viên: "+email+"?");
	}
</script>
@endsection