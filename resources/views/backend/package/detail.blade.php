						...
						<div class="bootstrap-table">
							<div class="table-responsive">
								...
								<div class="alert alert-primary" role="alert" align='right'>
                                    ...
                                    <a onClick="return index()" class="btn btn-warning" href="/admin/package/paid/{{ $order->id }}" role="button">đóng gói</a>
                                    @elseif ($order->trangthai==1)
                                    <a onClick="return index()" class="btn btn-primary" href="/admin/package/transport/{{ $order->id }}" role="button">giao hàng</a>
                                    @elseif ($order->trangthai==2)
                                    <a onClick="return index()" class="btn btn-success" href="/admin/package/successful/{{ $order->id }}" role="button">giao hàng thành công</a>
                                    @endif
								</div>
                                @endif
