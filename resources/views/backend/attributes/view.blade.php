...
<fieldset>
  <legend>[[.time_select.]]</legend>
    ...
    <script>
			  $('from_day').value='<?php if(Url::get('from_day')){echo Url::get('from_day');}else{ echo date('1/m/Y');}?>';

	</script>
    </td>
    <td> &nbsp;&nbsp;[[.to_day.]] &nbsp;&nbsp;</td><td><input type="text" name="to_day" id="to_day" class="date-input" onChange="changefromday();"/>
    <script>
			  $('to_day').value='<?php if(Url::get('to_day')){echo Url::get('to_day');}else{  echo date(''.cal_days_in_month(CAL_GREGORIAN, date('m'), date('Y')).'/m/Y');}?>';
        ...
        <td style="padding-left:10px;">
            ...
            <table id="tblExport" style="width:100%; border:1px solid #666; margin-top:10px; font-size:11px;" id="report">
               <tr valign="middle" bgcolor="#EFEFEF" style="padding-left:10px; height:30px;">
                    ...
                    <th style="text-align:center; width:70px;">[[.available_room1.]]</th>
                    <th style="text-align:center; width:50px;">%[[.oc.]] (6)</th>
                    <th style="text-align:center; width:50px;">[[.ooo.]] (7)</th>
                    <th style="text-align:center; width:50px;">[[.foc.]] (8)</th>
                    <!---<th style="border:1px solid #ccc; text-align:center; width:50px;">[[.pax.]]</th>--->
                   <th style="text-align:center; width:50px;">[[.dpt.]] (9)</th>
					<?php if([[=check_user=]]!=1){ ?>
                    <th style="text-align:center; width:100px;">[[.room_rev.]] (10)</th>
                    <th style="text-align:center; width:100px;">[[.extra_rev.]] (11)</th>
                    <th style="text-align:center; width:100px;">[[.total_room_rev.]] (12)</th>
                    <th style="text-align:center; width:100px;">[[.avg_rm.]] (13)</th>
				     <?php }?>
               ...
               <tr style="height:30px; border:1px solid #ccc;">
                   <td style="text-align:center;<?php if(Date('D',Date_time::to_time([[=items.id=]]))=='Sat'){echo 'color: red';}elseif(Date('D',Date_time::to_time([[=items.id=]]))=='Sun'){ echo 'color: blue';} ?>">[[|items.id|]]</td>
...
&nbsp;- (14) [[.average_room_rate.]] = (11)/(5)</p><br><br><br>
<script>
