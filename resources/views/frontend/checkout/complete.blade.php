						...
						<div class="col-12">
							<div class="order-wrapper mt-50">
								...
								<div class="order-list">
									...
									<div class="list-row d-flex justify-content-between">
										<div class="col-md-4">Sản phẩm: {{ $val->name }}</div>
										<div class="col-md-4" align='right'>x {{ $val->quantity }}</div>
										<div class="col-md-4" align='right'>{{ number_format($val->price*$val->quantity) }} ₫</div>
