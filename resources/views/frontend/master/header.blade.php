		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
						<div id="colorlib-logo" style="width: 300px;height: 50px; font-size: 20px;" >VIPRO</div>	{{-- <div id="colorlib-logo"><a href="/"><img src="images/logo.png" alt="" style="width: 300px;height: 50px;"></a></div> --}}
						</div>
